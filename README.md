...
```
2. remove any volumes associated with previous containers
```
docker volumen prune
```
3. rebuild fresh containers and volumes
```
docker-compose up
```
4. use datamodel.graphql to create prisma schema
```sh
prisma deploy
```
5. grab autogenerated schema and update the autogen file
```sh
